...
def main():
    ...
    commands = [
        ...
        f"cat  {os.path.join(output_dir, 'subdomains_alive.txt')} | katana | hakrawler -d 5 -dr -insecure -t 10 -timeout 3600 >> {os.path.join(output_dir, 'allurls.txt')}",
        f"cat {os.path.join(output_dir, 'subdomains_alive.txt')} | waybackurls >> {os.path.join(output_dir, 'allurls.txt')}",
        f"gospider -S {os.path.join(output_dir, 'subdomains_alive.txt')} -q -d 5 -c 10 --sitemap --no-redirect >> {os.path.join(output_dir, 'allurls.txt')}",
        ...
        f"cat {os.path.join(output_dir, 'allurks.txt')} | unfurl format %p | anew {os.path.join(output_dir, 'paths.txt')}",
